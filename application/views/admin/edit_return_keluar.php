<div class="container-fluid">
  <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Ubah Return Pemasok</h4>
      </div>
      <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#/dashboard">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="#/return_keluar">Return Pemasok</a></li>
            <li class="breadcrumb-item active">Ubah Return Pemasok</li>
          </ol>
        </div>
      </div>
  </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var no_return_keluar = location.hash.substr(21);
    ...
    $('#form_edit').on('submit', function(e){
      ...
      if(no_ref === '' || id_supplier === ''){
        ...
        if(stok<1) {
          ...
          $.ajax({
            url: `<?= base_url('api/return_keluar/edit/') ?>${auth.token}?no_return_keluar=${no_return_keluar}`,
            type: 'POST',
            dataType: 'JSON',
            beforeSend: function(){
