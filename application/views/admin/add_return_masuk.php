<div class="container-fluid">
  <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Tambah Return Pelanggan</h4>
      </div>
      <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Tambah Return Pelanggan</li>
          </ol>
        </div>
      </div>
  </div>
    ...
    $('#form_add').on('submit', function(e){
      ...
      if(no_ref === '' || id_customer === ''){
        ...
        if(stok<1) {
          ...
          $.ajax({
            url: '<?= base_url('api/return_masuk/add/') ?>'+auth.token,
            type: 'POST',
            dataType: 'JSON',
            beforeSend: function(){
