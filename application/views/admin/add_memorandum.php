<div class="container-fluid">
  <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Tambah Memorandum</h4>
      </div>
      <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Tambah Memorandum</li>
          </ol>
        </div>
      </div>
  </div>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header" style="background-color: #d63b70">
          <h4 class="m-b-0 text-white">Form Memorandum</h4>
        </div>
        <div class="card-body">
    ...
    $('#form_add').on('submit', function(e){
      ...
      if(keterangan_memo === ''){
        ...
        if(detail<1) {
          ...
          $.ajax({
            url: '<?= base_url('api/memorandum/add/') ?>'+auth.token,
            type: 'POST',
            dataType: 'JSON',
            beforeSend: function(){
